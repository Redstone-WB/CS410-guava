...
class LRR_Model:
    def __init__(self, k, v):
        ...
        self.m_mu           # prior for \alpha in each review
        self.m_sigma_inv    # precision matrix (NOT covariance!)
        self.m_sigma        # only used for calculating inverse(\Sigma)
        self.m_beta         # word sentiment polarity matrix should have one bias term!
        ...
        self.m_beta = np.zeros((self.m_k, self.m_k + 1), dtype=np.float64)
